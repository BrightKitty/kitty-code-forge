...
const projects = [
  {
    title: "ShopVault",
    category: "E-Commerce",
    description: "Full-stack e-commerce platform with real-time inventory and seamless checkout.",
  ...
  },
  {
    title: "InsightBoard",
    category: "Web Apps",
    description: "Analytics dashboard with interactive charts and role-based access control.",
    tech: ["TypeScript", "PostgreSQL", "D3.js"],
    image: portfolioDashboard,
  },
  {
    title: "Perriel Bistro",
    category: "Web Apps",
    description: "Restaurant website with online reservations and menu management CMS.",
  ...
  },
  {
    title: "FitPulse",
    category: "Mobile",
    description: "Fitness tracking app with workout plans, progress charts, and social features.",
  ...
  },
  {
    title: "HomeNest",
    category: "E-Commerce",
    description: "Real estate listing platform with advanced search filters and virtual tours.",
    tech: ["React", "AWS", "Mapbox"],
    image: portfolioRealestate,
  },
  {
    title: "Sancure Pay",
    category: "Mobile",
    description: "Fintech banking app with secure transactions and budget tracking tools.",
    tech: ["React Native", "Stripe", "JWT"],
                ...
                <div className="p-4 sm:p-6">
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {project.tech.map((t) => (
                      <span
                        key={t}
                        className="text-[10px] font-semibold tracking-wider uppercase bg-muted text-muted-foreground px-2 py-1 rounded"
                      >
                        {t}
                      </span>
                    ))}
